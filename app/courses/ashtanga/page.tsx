      ...
      <div className="w-full flex justify-center px-4 py-m-6 md:py-12">
        <div className="w-full max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-m-6 md:gap-8">
              {content.features.map((feature: any, index: number) => (
                ...
                >
                  ...
                  <h3 className="m-xl md:text-xl font-semibold text-gray-800 mb-m-4 md:mb-6 text-center px-2">
                    {feature.title}
                  </h3>
          ...
          <section className="mb-m-10 md:mb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-m-8 md:gap-12">
              {content.practiceStyles.map((style: any, index: number) => (
                <div key={index} className="bg-white rounded-2xl shadow-lg p-m-6 md:p-10 hover:shadow-xl transition-all duration-300">
                  <div className="m-4xl md:text-4xl text-red-800 mb-m-4 md:mb-6 flex justify-center">
                    <i className={style.icon}></i>
                  </div>
                  <h3 className="m-2xl md:text-2xl font-bold text-gray-800 mb-m-2 md:mb-2 text-center">
                    {style.title}
                  </h3>
                  <p className="text-red-800 m-lg md:text-lg font-medium mb-m-4 md:mb-6 text-center">
                    {style.subtitle}
                  </p>
                  <ul className="space-y-m-3 md:space-y-4">
                    {style.features.map((feature: string, featureIndex: number) => (
                      <li key={featureIndex} className="flex items-start">
                        ...
                        <span className="ml-3 text-gray-700 m-base md:text-base">{feature}</span>
                      </li>
                    ))}
                  </ul>
                </div>
          ...
          <section className="mb-m-10 md:mb-20">
            ...
            <p className="text-gray-600 text-center m-lg md:text-lg mb-m-6 md:mb-12 max-w-3xl mx-auto">
              {content.scheduleSubtitle}
            </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
              {content.scheduleItems.map((item: any, index: number) => (
                <div key={index} className="bg-white rounded-xl shadow-lg p-m-5 md:p-8 hover:shadow-xl transition-all duration-300 text-center">
                  <div className="m-3xl md:text-3xl text-red-800 mb-m-3 md:mb-4">
                    <i className={item.icon}></i>
                  </div>
                  <h4 className="m-xl md:text-xl font-semibold text-gray-800 mb-m-2 md:mb-2">
                    {item.title}
                  </h4>
                  <div className="text-red-800 font-medium mb-m-2 md:mb-3 m-base md:text-base">{item.time}</div>
                  <p className="text-gray-600 m-base md:text-base">{item.description}</p>
                </div>
              ))}
            </div>
            {/* 休息日信息 */}
            <div className="mt-m-6 md:mt-12 text-center">
              <p className="text-gray-700 font-medium m-base md:text-base">
          ...
          <section className="mb-m-10 md:mb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-m-6 md:gap-12">
              {/* 团体课 */}
              <div className="bg-white rounded-2xl shadow-lg p-m-6 md:p-10 hover:shadow-xl transition-all duration-300">
                <div className="mb-m-8 md:mb-10">
                  <h3 className="m-2xl md:text-2xl font-bold text-gray-800 mb-m-4 md:mb-4">
                    {content.groupTitle}
                  </h3>
                  <p className="text-gray-600 px-1 m-base md:text-base">
                ...
                <div className="space-y-m-4 md:space-y-8">
                  {content.groupPrices.map((price: any, index: number) => (
                    <div
                      key={index}
                      className="flex justify-between items-center py-m-4 md:py-6 border-b border-gray-100 last:border-0 px-2"
                    >
          ...
          {/* 希波介绍 */}
          <section className="mb-m-8 md:mb-12">
            <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-3xl p-m-6 md:p-10 shadow-lg">
              <div className="flex flex-col md:flex-row items-center gap-m-8 md:gap-16">
                ...
                <div className="flex-1 text-center md:text-left mt-m-6 md:mt-0">
                  <h3 className="m-2xl md:text-2xl font-bold text-gray-800 mb-m-4 md:mb-4">
                    {content.teacherName}
                  </h3>
                  <p className="text-red-800 font-medium mb-m-6 md:mb-8 m-lg md:text-lg">
                    {content.teacherSubtitle}
                  </p>
                  <p className="text-gray-700 leading-relaxed m-base md:text-lg">
